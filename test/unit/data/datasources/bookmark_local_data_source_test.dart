...
void main() {
  ...
  group('BookmarkLocalDataSource getAll', () {
    ...
    test('should return multiple bookmarks in stored order', () async {
      final a = bookmarkDto(id: '1', savedAtMillis: 1000);
    ...
    test('should skip entries that fail to parse', () async {
      final valid = bookmarkDto(id: '1').toJson();
  ...
  group('BookmarkLocalDataSource exists', () {
    ...
    test('should distinguish keys across communities', () async {
      final dto = bookmarkDto(community: CommunityId.humoruniv, id: '1');
      await dataSource.upsert(dto);
  ...
  group('BookmarkLocalDataSource upsert', () {
    ...
    test(
      ...
      () async {
        final original = bookmarkDto(id: '1', title: 'old');
        await dataSource.upsert(original);

        final updated = bookmarkDto(id: '1', title: 'new');
    ...
    test(
      ...
      () async {
        await dataSource.upsert(bookmarkDto(id: '1', savedAtMillis: 1000));
    ...
    test('should move updated bookmark to front', () async {
      ...
      await dataSource.upsert(
        bookmarkDto(id: '1', savedAtMillis: 3000, title: 'refreshed'),
      );
    ...
    test('should preserve other bookmarks when adding new one', () async {
      await dataSource.upsert(bookmarkDto(id: '1'));
