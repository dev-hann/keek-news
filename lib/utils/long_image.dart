class LongImage {
  ...
  /// Returns the multiplier to apply to `PhotoViewComputedScale.contained`
  /// so the image fills the viewport width (fit-width), enabling vertical
  /// reading of long images; or `null` when the image is not long.
  ///
